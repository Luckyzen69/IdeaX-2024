      ...
      >
        <div className="bg-purewhite border border-black rounded-lg m-2 p-4">
          ...
          <form action="" className="m-2 p-2 flex flex-col space-y-5 ">
            ...
            <div className="flex relative">
              <select value={gender}
                onChange={(e) => setgender(e.target.value)} name="" id="" className="w-96 p-2 border">
            ...
            <div className="flex relative">
              <select value={role}
                onChange={(e) => setrole(e.target.value)} name="" id="" className="w-96 p-2 border">
          ...
          <div className="flex flex-col justify-center items-center ">
            ...
            <Link to='/login' ><button className="w-2 underline underline-offset-2 font-bold text-accent">Login</button></Link>
            </div> 
            <p>or </p>
